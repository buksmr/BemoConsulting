            ...
            <div class="col-md-4">
               <div class="media">
                  <div class="media_top_images">
                     ...
                     <?php }else{ ?>
                     <img class="rounded mr-3" src="<?php echo base_url(); ?>assets/img/profile_pic1.jpg" alt="Generic placeholder image" style="width: 140px;">
                     <?php } ?>
                  ...
                  <div class="media-body md-robert-reoch">
					 ...
					 <h6><span class="jan_txt" style="font-size: 16px;"></span>(<?php echo $newformat; ?>)</h6>
                     <div class="btn-group-horizontal">
                        <!--<button type="button" class="btn btn-primary btn-prm-contact">Contact</button>-->
                        <!-- <button type="button" class="btn btn-primary btn-prm-inv-pro">Invite to a project</button>-->
                     </div>
                  </div>
               </div>
               <!-- media -->  
            ...
            <div class="carousel-inner products">
               ...
               <div class="carousel-item <?php echo $add_class; ?>">
                  <div class="row">
                     <?php }?>
                     <div class="col-md-4 col-sm-4 ">
                        <div class="main_portfolio_gallery">
                           <div class="card-gallery-pro">
                              <h5><?php echo $value1['project_name']?>
                              </h5>
                           </div>
                           <div class="card rebt_b_cls_section">
							<a href="<?php if($value1['project_url'] !=''){echo $value1['project_url'] ; }else{echo "#";}?>">
                              <img class="card-img-top" src="<?php echo base_url(); ?>uploads/portfolio/cover/<?php echo $value1['cover_photo'];?>" alt="image" style="width:100%; height:197px;"></a>
                              <div class="card-body project-cardmain-secion">
                                 <h5><?php echo $value1['project_title']?></h5>
                                 <div class="rebt_pro_portfolio">
                                    <div class="float-left reoch-img-txt">
                                       <img src="<?php echo base_url(); ?>uploads/portfolio/profile/<?php echo $value1['profile_photo'];?>" class="img-fluid" alt="....">
                                    </div>
                                    <div class="float-right reoch-rt-txt">
                                       <h5><?php echo $value1['user_name']?></h5>
                                    </div>
                                 </div>
                              </div>
                           </div>
            ...
            <div class="col-sm-10 references-10">
               ...
               <div id="Recentdemo" class="carousel slide" data-ride="carousel">
                  ...
                  <ul class="carousel-indicators" style="display: none;">
                     <li data-target="#Recentdemo" data-slide-to="0" class="active"></li>
                     <li data-target="#Recentdemo" data-slide-to="1"></li>
                  </ul>
                  <div class="carousel-inner products">
                     <?php
                        $j=0;
...
<section class="skills_section">
   <div class="container-fluid">
      <div class="container">
         <h4 class="skillHdg">SKILLS </h4>
         <?php
            foreach ($skill_list as  $value) { ?> 
         <h6 class="skill-main-heading"><?php echo $value['skill_name']; ?> </h6>
