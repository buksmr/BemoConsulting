                ...
                <?php } ?>
				   ...
				   <label class="block clearfix">
						<span class="block input-icon input-icon-right">
							...
							<input type="password" class="form-control" placeholder="New Password" name="text_newpass" required="" />
					...
					<label class="block clearfix">
						<span class="block input-icon input-icon-right">
							<input type="password" class="form-control" placeholder="Confirm Password" name="text_confirmpass" required="" />
