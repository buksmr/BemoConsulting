...
<html>
   ...
   <body>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <?php if(isset($search)){
                     ...
                     $quelist=$this->db->query("SELECT title FROM `tbl_upload_project_opening` where is_delete =0; ");			
                  ...
                  <?php
                     ...
                     $is_login_from_google=$user_profiledata->is_login_from_google; 	
                     	...
                     	?>
                  <li class="nav-item dropdown dafterprojectopeningmenu">	
                  <!--<div class="dropdown">-->
                  ...
                  <?php }else{ ?>
                  <a class="nav-link dropdown-toggle" href="#" id="navbardrop" 
                      role="button" data-hover="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid"  id="img_profile" src="<?php echo base_url(); ?>assets/img/profile_edit.png" alt="Profile"></a>
                  <?php } ?>
                  <div class="dropdown-menu dropdown-submenu-homepf sm-menu" aria-labelledby="navbardrop">
      ...
      <div class="row">
      <?php
         $sub_category=$this->Front_model->get_sub_category_list_opening($value['id']); 
          foreach ($sub_category as  $value2) { ?>
      <div class="col-md-3"><a href="<?php echo base_url(); ?>freelancer_project_opening/<?php echo base64_encode($value['id']); ?>/<?php echo base64_encode($value2['id']); ?> "> <?php echo $value2['sub_cat_name_opening']; ?> </a></div>
      <?php } ?>
      </div>
      </div>
      </div>   <!-- main dropdown -->
