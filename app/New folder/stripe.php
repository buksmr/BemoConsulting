        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
					...
					/* $res=$this->db->query("SELECT sum(sub_total) as finaltotal,sum(delivery_fees) as deliverycharges,count(id) as cartcount FROM cart where user_id='".$_SESSION['user_id']."'")->row();
...
?>
                    ...
                    <form role="form" action="<?php echo base_url();?>add_data" method="post" class="require-validation"
                                                     data-cc-on-file="false"
                                                    data-stripe-publishable-key="<?php echo $this->config->item('stripe_key') ?>"
                                                    id="payment-form">
						<input class='form-control' type='hidden' value="10" name="amount">
