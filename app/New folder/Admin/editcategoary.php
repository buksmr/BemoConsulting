...
<!--============ Sidebar END Here============-->
			...
			<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <form action="<?php echo base_url(); ?>Admin/update_subcat" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<input type="text" id="" placeholder="Harry"  class="form-control" name="text_sub_cat_name" value="<?php echo $sub_cat->sub_cat_name; ?>">
								</div>
							</div>
							<input type="hidden" id=""   class="form-control" name="sub_cat_image_old" value="<?php echo $sub_cat->sub_cat_image; ?>">
